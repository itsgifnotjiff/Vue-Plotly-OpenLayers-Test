<template>
  <div class="home">
    <v-flex>
      <v-card>
        <v-container>
          <p class="text-center display-2 font-weight-bold">Teaching myself the basics</p>
          <p class="text-center headline">The navigation bar on top has the folliwing elements</p>
          <ul>
